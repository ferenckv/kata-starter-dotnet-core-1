...
namespace Kata.Spec
{
    ...
    public class when_adding_an_unknown_amount_of_numbers
    {
        ...
        It should_return_the_sum_of_all_the_number = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_user_nput_contains_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_throw_an_exception_containing_that_negative_number = () => { _result.Message.Should().Be("negatives not allowed: -3"); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_contains_numbers_larger_than_1000
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("1,1002,3"); };

        It should_sum_the_numbers_less_than_1001 = () => { _result.Should().Be(4); };
        static Calculator _systemUnderTest;
        static int _result;
    }
