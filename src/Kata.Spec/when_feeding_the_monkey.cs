...
namespace Kata.Spec
{
    ...
    public class when_summing_with_multiple_negatives
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_summing_numbers_larger_than_1000
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("2,1001,3"); };

        It should_sum_numbers_less_than_1001 = () => { _result.Should().Be(5); };
        static Calculator _systemUnderTest;
        static int _result;
    }
