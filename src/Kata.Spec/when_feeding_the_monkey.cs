...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_empty
    {
        ...
        It should_be_zero = () => { _result.Should().Be(0); };
    ...
    public class when_user_input_is_two_numbers
    {
        ...
        It should_be_the_sum_of_those_two = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_using_a_new_line_as_a_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_be_the_sum_pf_the_numbers = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_user_input_includes_numbers_larder_than_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_only_sum_the_numbers_less_than_1001 = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_using_input_includes_one_multi_character_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_includes_multiple_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
