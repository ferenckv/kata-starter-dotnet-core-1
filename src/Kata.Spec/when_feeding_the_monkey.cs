...
namespace Kata.Spec
{
    ...
    public class when_adding_two_numbers
    {
        ...
        It should_return_the_sum_of_the_numbers = () => { _result.Should().Be(5); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_adding_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_throw_an_exception_with_that_negative_numbers = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        static Calculator _systemUnderTest;
    ...
    public class when_adding_numbers_larger_than_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = _systemUnderTest.Add("1,2,1002"); };
    ...
    public class when_using_a_multi_char_custom_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
